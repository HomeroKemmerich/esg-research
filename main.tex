...
\begin{document}
	...
	Como resultado do estudo, foi possível observar uma redução significativa quando comparados os serviços de nuvem aos datacenters tradicionais, tendo como razão a diferença em processos operacionais, equipamento e infraestrutura. Além disso, também foi levada em conta a aquisição de créditos de carbono \cite{microsoftCarbonBenefitsCloud2020}
